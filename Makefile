...
ROM_NAME := Enhanced_Starters_-_Physical_Dragon_-_Pokemon_Emerald_Legacy_Enhanced.gba
ELF_NAME := $(ROM_NAME:.gba=.elf)
MAP_NAME := $(ROM_NAME:.gba=.map)
OBJ_DIR_NAME := build/emerald

MODERN_ROM_NAME := Modern_Enhanced_Starters_-_Physical_Dragon_-_Pokemon_Emerald_Legacy_Enhanced.gba
