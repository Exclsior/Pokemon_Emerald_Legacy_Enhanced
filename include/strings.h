...
extern const u8 gText_MainMenuOptionGameAndVersion[];
extern const u8 gText_MainMenuContinue[];
extern const u8 gText_MainMenuMysteryGift2[];
extern const u8 gText_MainMenuMysteryEvents[];
extern const u8 gText_MainMenuGameAndVersion[];
...
extern const u8 gText_Birch_LookLike[];
extern const u8 gText_Birch_Nuzlocke[];
extern const u8 gText_Birch_DexType[];
...
extern const u8 gText_Birch_AreYouSure_HoennDex[];
extern const u8 gText_Birch_AreYouSure_NationalDex[];
...
extern const u8 gText_LookEmerald[];
extern const u8 gText_LookRS[];
extern const u8 gText_Birch_HoennDex[];
extern const u8 gText_Birch_NationalDex[];
...
extern const u8 gText_KissPosterCost[];
extern const u8 gText_KissCushionCost[];
extern const u8 gText_SmoochumDollCost[];
extern const u8 gText_TogepiDollCost[];
extern const u8 gText_MeowthDollCost[];
extern const u8 gText_ClefairyDollCost[];
extern const u8 gText_DittoDollCost[];
extern const u8 gText_CyndaquilDollCost[];
extern const u8 gText_ChikoritaDollCost[];
extern const u8 gText_TotodileDollCost[];

extern const u8 gText_LaprasDollCost[];
extern const u8 gText_SnorlaxDollCost[];
extern const u8 gText_VenusaurDollCost[];
extern const u8 gText_CharizardDollCost[];
extern const u8 gText_BlastoiseDollCost[];

extern const u8 gText_ProteinCost[];
extern const u8 gText_CalciumCost[];
extern const u8 gText_IronCost[];
...
extern const u8 gText_LeftoversCost[];
extern const u8 gText_WhiteHerbCost[];
extern const u8 gText_QuickClawCost[];
extern const u8 gText_MentalHerbCost[];
extern const u8 gText_BrightPowderCost[];
extern const u8 gText_ChoiceBandCost[];
extern const u8 gText_KingsRockCost[];
extern const u8 gText_FocusBandCost[];
extern const u8 gText_ScopeLensCost[];
extern const u8 gText_MetalCoatCost[];
extern const u8 gText_AmuletCoinCost[];
extern const u8 gText_ExpShareCost[];
extern const u8 gText_LuckyEggCost[];
extern const u8 gText_MachoBraceCost[];
extern const u8 gText_CleanseTagCost[];
extern const u8 gText_SmokeBallCost[];
extern const u8 gText_SootheBellCost[];
extern const u8 gText_EverstoneCost[];

extern const u8 gText_LiechiCost[];
extern const u8 gText_GanlonCost[];
extern const u8 gText_SalacCost[];
extern const u8 gText_PetayaCost[];
extern const u8 gText_ApicotCost[];
extern const u8 gText_PomegCost[];
extern const u8 gText_KelpsyCost[];
extern const u8 gText_QualotCost[];
extern const u8 gText_HondewCost[];
extern const u8 gText_GrepaCost[];
extern const u8 gText_TamatoCost[];
...
extern const u8 gText_SoftboiledCost[];
extern const u8 gText_SeismicTossCost[];
extern const u8 gText_DreamEaterCost[];
extern const u8 gText_MegaPunchCost[];
extern const u8 gText_MegaKickCost[];
extern const u8 gText_BodySlamCost[];
extern const u8 gText_RockSlideCost[];
extern const u8 gText_CounterCost[];
extern const u8 gText_ThunderWaveCost[];
extern const u8 gText_SwordsDanceCost[];
extern const u8 gText_DefenseCurlCost[];
extern const u8 gText_SnoreCost[];
extern const u8 gText_MudSlapCost[];
extern const u8 gText_SwiftCost[];
extern const u8 gText_IcyWindCost[];
extern const u8 gText_EndureCost[];
extern const u8 gText_PsychUpCost[];
extern const u8 gText_IcePunchCost[];
extern const u8 gText_ThunderPunchCost[];
extern const u8 gText_FirePunchCost[];

// Battle Frontier Move Tutors - Free
extern const u8 gText_SoftboiledFree[];
extern const u8 gText_SeismicTossFree[];
extern const u8 gText_DreamEaterFree[];
extern const u8 gText_MegaPunchFree[];
extern const u8 gText_MegaKickFree[];
extern const u8 gText_BodySlamFree[];
extern const u8 gText_RockSlideFree[];
extern const u8 gText_CounterFree[];
extern const u8 gText_ThunderWaveFree[];
extern const u8 gText_SwordsDanceFree[];
extern const u8 gText_DefenseCurlFree[];
extern const u8 gText_SnoreFree[];
extern const u8 gText_MudSlapFree[];
extern const u8 gText_SwiftFree[];
extern const u8 gText_IcyWindFree[];
extern const u8 gText_EndureFree[];
extern const u8 gText_PsychUpFree[];
extern const u8 gText_IcePunchFree[];
extern const u8 gText_ThunderPunchFree[];
extern const u8 gText_FirePunchFree[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AmuletCoinDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ExpShareDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LuckyEggDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MachoBraceDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CleanseTagDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SmokeBallDesc[];
...
extern const u8 gPCText_Magma1[];
