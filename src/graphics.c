...
const u16 gBattleInterface_BallStatusBarPalWhite[] = INCBIN_U16("graphics/battle_interface/ball_status_bar_white.gbapal");
...
const u16 gTitleScreenEmeraldLegacyEnhancedPal[]  = INCBIN_U16("graphics/title_screen/emerald_legacy_enhanced.gbapal");
...
const u32 gTitleScreenEmeraldLegacyEnhancedLeftGfx[]  = INCBIN_U32("graphics/title_screen/emerald_legacy_enhanced_left.8bpp.lz");
const u32 gTitleScreenEmeraldLegacyEnhancedRightGfx[]  = INCBIN_U32("graphics/title_screen/emerald_legacy_enhanced_right.8bpp.lz");
...
const u16 gFrontierPassBg_Pal2[]                         = INCBIN_U16("graphics/frontier_pass/bg2.gbapal"); // 8 x 16
