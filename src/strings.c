...
const u8 gText_MainMenuOptionGameAndVersion[] = _("OPTION - LEGACY ENHANCED - Ver. 1.1.4");
...
const u8 gText_MainMenuGameAndVersion[] = _("EMERALD LEGACY ENHANCED - Ver. 1.1.4");
...
const u8 gText_Birch_LookLike[] = _("What do you look like?");
const u8 gText_LookEmerald[] = _("ORIGINAL");
const u8 gText_LookRS[] = _("CLASSIC");
const u8 gText_Birch_HoennDex[] = _("HOENN DEX");
const u8 gText_Birch_NationalDex[] = _("NATIONAL DEX");
...
//const u8 gText_ChoosePokemonSelectToMove[] = _("Choose a POKéMON."); // Backup original
const u8 gText_ChoosePokemonSelectToMove[] = _("{FONT_SMALL}{A_BUTTON} CHOOSE {START_BUTTON} SUMMARY"); // Added text to note Select can move a Pokemon, removed from Daycare flags to use for Sel instead
const u8 gText_SelectToMove[] = _("{SELECT_BUTTON} SWITCH");
const u8 gText_ConfirmMove[] = _("{SELECT_BUTTON} CONFIRM");
const u8 gText_StartToSummary[] = _("{START_BUTTON} SUMMARY");
...
const u8 gText_50CoinsAndPrice[] = _  ("50 COINS{CLEAR_TO 0x40}¥1,000");
const u8 gText_500CoinsAndPrice[] = _ ("500 COINS{CLEAR_TO 0x40}¥10,000");
const u8 gText_1000CoinsAndPrice[] = _("1000 COINS{CLEAR_TO 0x40}¥20,000");
const u8 gText_2500CoinsAndPrice[] = _("2500 COINS{CLEAR_TO 0x40}¥50,000");
const u8 gText_5000CoinsAndPrice[] = _("5000 COINS{CLEAR_TO 0x40}¥100,000");
...
const u8 gPCText_Magma1[] = _("MAGMA 1");
...
const u8 gText_PpUpCost[] = _("PP UP{CLEAR_TO 0x64}1BP");
const u8 gText_PpMaxCost[] = _("PP MAX{CLEAR_TO 0x64}3BP");
...
const u8 gText_TrainerCardSIDNo[] = _("SIDNo.");
...
const u8 gText_TextSpeedMid[] = _("MEDIUM");
