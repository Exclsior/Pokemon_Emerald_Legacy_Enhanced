...
const u8 gText_MonOverworld[] = _("POKéMON FOLLOWER");
...
const u8 gText_TypeEffect[] = _("TYPE EFFECTS");
const u8 gText_TypeEffectOn[] = _("ON");
const u8 gText_TypeEffectOff[] = _("OFF");
...
const u8 gText_MonOverworldOn[] = _("ON");
const u8 gText_MonOverworldOff[] = _("OFF");
