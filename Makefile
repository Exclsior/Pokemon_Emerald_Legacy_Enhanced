...
ROM_NAME := Sceptile_Dragon_Physical-_Pokemon_Emerald_Legacy_Enhanced.gba
ELF_NAME := $(ROM_NAME:.gba=.elf)
MAP_NAME := $(ROM_NAME:.gba=.map)
OBJ_DIR_NAME := build/emerald

MODERN_ROM_NAME := Modern_Sceptile_Dragon_Physical_-_Pokemon_Emerald_Legacy_Enhanced.gba
