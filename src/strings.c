...
const u8 gText_MainMenuOptionGameAndVersion[] = _("OPTION - STRTRS. P. DRAGON - Ver. 1.1.4");
...
const u8 gText_MainMenuGameAndVersion[] = _("STARTERS PHYSICAL DRAGON - Ver. 1.1.4");
